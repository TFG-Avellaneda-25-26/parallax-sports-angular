export { AccountComponent } from './ui/account/account.component';
export { PreferencesComponent } from './ui/preferences/preferences.component';
...
export { accountI18n } from './i18n/settings.i18n';
